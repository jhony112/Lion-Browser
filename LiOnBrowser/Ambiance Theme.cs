    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int ItemIndex = 0; ItemIndex <= TabCount - 1; ItemIndex++)
        {
            ...
            if (ItemIndex == SelectedIndex)
            {
                ...
                try
                {
                    //G.DrawString("V", Font, Brushes.Black, 50, 75);
                    ...
                    G.DrawString("X", new Font(Font.Name, Font.Size - 1, FontStyle.Bold), new SolidBrush(Color.Red), new Rectangle(GetTabRect(ItemIndex).Location, GetTabRect(ItemIndex).Size ), new StringFormat
                    {
